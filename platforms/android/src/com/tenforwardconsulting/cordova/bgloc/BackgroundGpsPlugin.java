...
public class BackgroundGpsPlugin extends CordovaPlugin {
    ...
    public static BackgroundGpsPlugin plugin;
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) {
        ...
        if (ACTION_START.equalsIgnoreCase(action) && !isEnabled) {
        	...
        	try {
	        	...
	        	Location l = LocationUpdateService.lastLocation;
	        	
	        	if(l != null) {
	        		JSONObject parameter = new JSONObject();
	            	parameter.put("latitude", l.getLatitude());
	            	parameter.put("longitude", l.getLongitude());
	            	parameter.put("accuracy", l.getAccuracy());
	            	parameter.put("speed", l.getSpeed());
	            	parameter.put("bearing", l.getBearing());
	            	parameter.put("altitude", l.getAltitude());
	                
	            	JSONObject params = new JSONObject();
	                j.put("location", parameter);
   ...
   /* public void sendLocation(PluginResult result) {
