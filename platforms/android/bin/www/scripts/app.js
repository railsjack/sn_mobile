...
//    		$rootScope.isLoggedIn = wcsLocalStorage.get('currentUser')!=null && wcsLocalStorage.get('currentUser')!="";
			...
			$rootScope.onSuccessForLocation = function(position) {
				...
				gLat = lat;
				gLng = lng;
				alert('onSuccessForLocation::>' + gLat + ',  ' + gLng);
				//console.log('updating location...');
				 // alert('onSuccessForLocation: gLat' + gLat + ', gLng: ' + gLng);
...
function setupLocationPlugin() {
    ...
    */
    ...
    bgGeo.configure(callbackFn, failureFn, {
        url: apiURL+'/employee/325/current_location', // <-- only required for Android; ios allows javascript callbacks for your http
